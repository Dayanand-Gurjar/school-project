            ...
            <div className="footer__content">
              ...
              <div className="footer__section">
                ...
                <div className="footer__social">
                  <a href={SCHOOL_CONTACT.social.facebook} className="footer__social-link" aria-label="Facebook">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path d="M18 2H15C13.6739 2 12.4021 2.52678 11.4645 3.46447C10.5268 4.40215 10 5.67392 10 7V10H7V14H10V22H14V14H17L18 10H14V7C14 6.73478 14.1054 6.48043 14.2929 6.29289C14.4804 6.10536 14.7348 6 15 6H18V2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </a>
                  <a href={SCHOOL_CONTACT.social.twitter} className="footer__social-link" aria-label="Twitter">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <a href={SCHOOL_CONTACT.social.instagram} className="footer__social-link" aria-label="Instagram">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <a href={SCHOOL_CONTACT.social.linkedin} className="footer__social-link" aria-label="LinkedIn">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <div className="footer__section">
                ...
                <div className="footer__contact">
                  <div className="footer__contact-item">
                    ...
                    <span>{SCHOOL_CONTACT.address.full}</span>
                  </div>
                  <div className="footer__contact-item">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <span>{SCHOOL_CONTACT.phone.main}</span>
                  </div>
                  <div className="footer__contact-item">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <span>{SCHOOL_CONTACT.email.general}</span>
                  </div>
                  <div className="footer__contact-item">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <span>{SCHOOL_CONTACT.hours.general}</span>
                  </div>
                </div>
              </div>
            </div>
